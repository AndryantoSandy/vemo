...
<div class="container-fluid">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/customers/save" commandName="customers">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Member Number</label>
                        <div class="col-sm-4">
                            <input type="text" name="memberNumber" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
